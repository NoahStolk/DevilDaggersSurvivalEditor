...
namespace DevilDaggersSurvivalEditor.Code.User
{
	...
	public class UserSettings
	{
		...
		public bool SurvivalFileIsValid => Program.App.userSettings.SurvivalFileExists && Spawnset.TryParse(new FileStream(Program.App.userSettings.SurvivalFileLocation, FileMode.Open, FileAccess.Read), out _);
	}
}