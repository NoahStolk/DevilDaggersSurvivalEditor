...
{
	public partial class WindowArenaPyramid : Window
	{
		public ArenaPyramid arena;

		public WindowArenaPyramid()
		{
			InitializeComponent();
		}
		...
		private void OKButton_Click(object sender, RoutedEventArgs e)
		{
			...
			arena = new ArenaPyramid(x1, y1, x2, y2, startHeight, endHeight);
			DialogResult = true;
		}
	}
}